...
def report():
    with open("Report_Translator.txt","r",encoding="utf8") as file1:
    ...
    mylist2=Listbox(rpt, yscrollcommand = scrollbar.set)
    for line in text2:  
        mylist2.insert(END,line)  
    mylist2.pack( fill = BOTH ,expand=True)
...
Label(root, text='Made By - Ashwani Dhankhar ',bd='5',bg="#ebedeb").place(relx = 0.8, rely = 0.9, anchor = CENTER) 
